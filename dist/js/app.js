(() => {
    ...
    (() => {
        ...
        class Popup {
            ...
            eventsPopup() {
                document.addEventListener("click", function(e) {
                    ...
                    if (buttonClose || !e.target.closest(`.${this.options.classes.popupContent}`) && this.isOpen && !e.target.closest(".lg-container")) {
                        e.preventDefault();
                        this.close();
                        return;
                    }
        ...
        modules_flsModules.tippy = tippy_esm("[data-template]", {
            content(reference) {
        ...
        function initSliders() {
            if (document.querySelector(".portfolio-item__slider_creek")) new core(".portfolio-item__slider_creek", {
                ...
                pagination: {
                    el: ".portfolio-item__pagination_creek",
                    type: "fraction"
                },
                navigation: {
                    prevEl: ".portfolio-item__navigation_prev-creek",
                    nextEl: ".portfolio-item__navigation_next-creek"
                }
            });
            if (document.querySelector(".portfolio-item__slider_cove")) new core(".portfolio-item__slider_cove", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                resizeObserver: false,
                pagination: {
                    el: ".portfolio-item__pagination_cove",
                    type: "fraction"
                },
                navigation: {
                    prevEl: ".portfolio-item__navigation_prev-cove",
                    nextEl: ".portfolio-item__navigation_next-cove"
                }
            });
            if (document.querySelector(".portfolio-item__slider_gate")) new core(".portfolio-item__slider_gate", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                resizeObserver: false,
                pagination: {
                    el: ".portfolio-item__pagination_gate",
                    type: "fraction"
                },
                navigation: {
                    prevEl: ".portfolio-item__navigation_prev-gate",
                    nextEl: ".portfolio-item__navigation_next-gate"
                }
            });
            if (document.querySelector(".floor__slider")) new core(".floor__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                resizeObserver: false,
                pagination: {
                    el: ".floor__pagination",
                    type: "fraction"
                },
                navigation: {
                    prevEl: ".floor__navigation_prev",
                    nextEl: ".floor__navigation_next"
                }
            });
        }
...
***************************************************************************** */
        ...
        window.addEventListener("load", (() => {
            ...
            setTimeout((() => {
                modules_flsModules.popup.open("#offer");
            }), 3e4);
        }));
        window["FLS"] = false;
        isWebp();
